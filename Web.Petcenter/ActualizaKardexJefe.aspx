<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ActualizaKardexJefe.aspx.cs" Inherits="Web.Petcenter.ActualizaKardexJefe" %>
                                                    ...
                                                    <asp:GridView ID="grvresultado" runat="server" class="table table-bordered" Width="100%"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="ACCIÓN">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="ibtnModificar" runat="server" AlternateText="Modificar" CausesValidation="false" Visible='<%# Eval("Modificar2") %>'
                                                                    ...
                                                                    <asp:Button ID="ibtnAnular" runat="server" AlternateText="Aprobar" CausesValidation="false" Visible='<%# Eval("Aprobar") %>'
                                                                        CommandArgument='<%# Bind("idMovimiento") %>' CommandName="Aprobar" Text="Aprobar" CssClass="btn btn-default" Style="min-width: 70px" Font-Size="X-Small" />

                                                                    <itemstyle width="5%" />
                                                                    <asp:Button ID="Button1" runat="server" AlternateText="Rechazar" CausesValidation="false" Visible='<%# Eval("Rechazar") %>'
                                                                        CommandArgument='<%# Bind("idMovimiento") %>' CommandName="Rechazar" Text="Rechazar" CssClass="btn btn-default" Style="min-width: 70px" Font-Size="X-Small" />
