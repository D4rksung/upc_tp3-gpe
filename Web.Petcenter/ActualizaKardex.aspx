                ...
                <section>
                    ...
                    <div class="container" style="width: 100%">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#Movimientos">Movimientos</a></li>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <asp:GridView ID="grvresultado" runat="server" class="table table-bordered" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="FECHAMOV" HeaderText="FECHA MOV">
                                                        <ItemStyle VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="NROGUIA" HeaderText="N° GUIA">
                                                        <ItemStyle VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CANTTOTAL" HeaderText="CANT TOTAL">
                                                        <ItemStyle VerticalAlign="Middle" />
                                                    </asp:BoundField>
                        ...
                        <div class="modal-body">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Tipo Mov:</div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Fecha Mov:<font size="2" color="red"> </font></div>
                                                            <asp:TextBox ID="txtFechaMov" runat="server" class="form-control datepicker" placeholder="Fecha Mov" onBlur="javascript:ValidarFecha(this)"></asp:TextBox>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Guia Remisión:<font size="2" color="red"> </font></div>
                                                               <asp:TextBox ID="txtGuia" runat="server"  class="form-control" placeholder="" Style="width: 100%"></asp:TextBox>
                            ...
                            <div class="row">
                                        <div style="height: 180px; width: 820px; overflow: auto">
                                            <asp:GridView ID="gvMateriales" runat="server" class="table table-bordered" Width="700px" Height="100px"
                                                AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" ShowHeaderWhenEmpty="false" ShowHeader="true" PageSize="3"
                                                DataKeyNames="IdMaterial">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="PRECIO">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtprecioCompra" Width="50px" runat="server" onblur="fn_formatDecimal(2)"  onkeypress="return PriceMask(this)"  Style="text-align: center" Text='<%# Eval("Precio") %>' ></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="CANTIDAD">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtCantidad" Width="50px" runat="server" onblur="fn_formatDecimal(0)" type="number" Style="text-align: center" onkeypress="return PriceMask(this)" Text='<%# Eval("Cantidad") %>'></asp:TextBox>
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                        <div style="height: 180px; width: 820px; overflow: auto">
                                            <asp:GridView ID="gvMaterialesV" runat="server" class="table table-bordered" Width="600px" Height="100px"
                    ...
                    <div class="modal-footer">
                        <asp:Button runat="server" Text="Cerrar" data-dismiss="modal" CssClass="btn btn-default" ID="btnCancelarV" Style="width: 30%" />
